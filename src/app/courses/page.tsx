...
export default function CoursesPage() {
  ...
  const categories = ["All", "Cybersecurity", "Development", "Bug Bounty"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-12">
          ...
          <p className="text-base sm:text-lg text-neutral-700 font-medium mt-4 leading-relaxed">
            Hands-on, zero-fluff video masterclasses taught by Raghav Arora. Learn practical ethical hacking, web development, and bug bounty hunting.
          </p>
        </div>
          ...
          {filteredCourses.map((course) => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                >
                  <span>{course.badge === "Coming Soon" ? "View Topics" : "Enroll Now"}</span>
